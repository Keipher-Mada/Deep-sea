...
new Swiper('#projects .swiper-container', {
  ...
  observeParents: true,
   ...
   $(function(){
     ...
     $('.home-link').on('click',function(){
      gsap.to('.pillican-eel', 0.5, { scale: 0.9 });
      gsap.to('.pillican-eel', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
      gsap.to('.pillican-eel', 0, { display: 'none', delay: 0.7 });
      gsap.to('.vampire-squid', 0.5, { scale: 0.9 });
      gsap.to('.vampire-squid', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
      gsap.to('.vampire-squid', 0, { display: 'none', delay: 0.7 });
      gsap.to('.comb-jelly', 0.5, { scale: 0.9 });
      gsap.to('.comb-jelly', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
    ...
    $('.angler-project').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.angler-fish', 0, { display: 'block', delay: 0.7 });
      gsap.to('.angler-fish', 0.5, { scale: 1, delay: 1.1 });
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.jelly-project').on('click',function(){
      gsap.to('#home',.5,{scale:.9});
      gsap.to('#home',0,{width:'100%',height:'100vh',overflow:'hidden'});
      gsap.to('#home',0,{display:'none',delay:.7});
      gsap.to('.comb-jelly', 0, { display: 'block', delay: 0.7 });
      gsap.to('.comb-jelly', 0.5, { scale: 1, delay: 1.1 });
      gsap.to('.project-name',.5,{opacity:0,delay:2.5})
      gsap.to('#breaker',{display:'block'})
      gsap.to('#breaker',0,{display:'none',delay:1.7});
    })
    $('.squid-project').on('click', function () {
      gsap.to('#home', 0.5, { scale: 0.9 });
      gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
      gsap.to('#home', 0, { display: 'none', delay: 0.7 });
      gsap.to('.vampire-squid', 0, { display: 'block', delay: 0.7 });
      gsap.to('.vampire-squid', 0.5, { scale: 1, delay: 1.1 });
      gsap.to('.project-name', 0.5, { opacity: 0, delay: 2.5 });
      gsap.to('#breaker', { display: 'block' });
      gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
    });
    $('.eel-project').on('click', function () {
      gsap.to('#home', 0.5, { scale: 0.9 });
      gsap.to('#home', 0, { width: '100%', height: '100vh', overflow: 'hidden' });
      gsap.to('#home', 0, { display: 'none', delay: 0.7 });
      gsap.to('.pillican-eel', 0, { display: 'block', delay: 0.7 });
      gsap.to('.pillican-eel', 0.5, { scale: 1, delay: 1.1 });
      gsap.to('.project-name', 0.5, { opacity: 0, delay: 2.5 });
      gsap.to('#breaker', { display: 'block' });
      gsap.to('#breaker', 0, { display: 'none', delay: 1.7 });
    });
